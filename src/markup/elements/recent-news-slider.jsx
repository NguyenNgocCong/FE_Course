			...
			<div className="section-area section-sp1">
				<div className="container">
					<div className="heading-bx left">
						<h2 className="title-head">Read A Top <span>Blog</span></h2>
						<p>A place containing huge treasures of knowledge to help you reach your dreams</p>
					</div>
				...
				<div className="container">
					<div className="heading-bx left">
						<h2 className="title-head">Read A News <span>Blog</span></h2>
					</div>
					<Slider {...settings} className="recent-news-carousel slick-slider owl-btn-1">
						{recentBlog.map((item) => (
							<div className="slider-item">
